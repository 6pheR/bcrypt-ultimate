...
final class BcryptImpl {
    ...
    /**
     * Hashes the input using bcrypt, cost factor, and salt.
     *
     ...
     */
    static String hash(byte[] input, int cost, byte[] saltBytes) {
        ...
        return BcryptEncoding.encodeHash(saltBytes, cost, hash);
    }
